...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const buttons = document.querySelectorAll('button:not(.hamburger):not(.search-btn):not(.tool-btn):not(.btn-danger-text):not(.btn-danger-full):not(.auth-tab), .btn-new-article');
    buttons.forEach(btn => {
